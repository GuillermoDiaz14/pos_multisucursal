...
<div style="padding:16px 20px;">
    ...
    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:16px;flex-wrap:wrap;gap:8px;">
        <div>
            <h3 style="margin:0;font-size:18px;color:#2c3e50;font-weight:700;">
                <i class="fa fa-address-card text-primary"></i> Editar cliente
            </h3>
    ...
    <div class="form-card">
        ...
        <form role="form" id="editCliente" action="<?php echo base_url(); ?>cliente/editcliente" method="post">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="doc_identidad" id="doc_identidad"
                               value="<?php echo htmlspecialchars($doc_identidad, ENT_QUOTES); ?>"
                               maxlength="50" required />
                    </div>
                </div>
                <div class="col-md-6">
