...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-user-circle-o" aria-hidden="true"></i> Lista cliente
        <small>cliente</small>
      </h1>
    </section>
        ...
        <div class="row">
            <div class="col-xs-12 text-right">
                <div class="form-group">
                    <a class="btn btn-primary" href="<?php echo base_url(); ?>cliente/add"><i class="fa fa-plus"></i> Agregar nuevo cliente</a>
                </div>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                    ...
                    <div class="box-tools">
                        <form action="<?php echo base_url() ?>cliente/cliente_lista" method="POST" id="searchList">
...
<script>
    function filterTable() {
        ...
        $.ajax({
            url: '<?php echo base_url() ?>cliente/filterclientes',
            type: 'POST',
