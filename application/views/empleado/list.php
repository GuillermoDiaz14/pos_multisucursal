        ...
        <div class="row">
            <div class="col-xs-12 text-right">
                <div class="form-group">
                    <a class="btn btn-primary" href="<?php echo base_url(); ?>empleado/add"><i class="fa fa-plus"></i> Agregar nuevo empleado</a>
                </div>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Lista empleado</h3>
                    <div class="box-tools">
                        <form action="<?php echo base_url() ?>empleado/empleadoListing" method="POST" id="searchList">
                            <div class="input-group">
                              <input type="text" name="searchText"   class="form-control input-sm pull-right" style="width: 150px;" placeholder="Search" id="searchText" oninput="filterTable()" />
...
<script>
    function filterTable() {
        ...
        $.ajax({
            url: '<?php echo base_url() ?>empleado/filterEmployees',
            type: 'POST',
            ...
            success: function (response) {
                ...
                $('#employeeTable').addClass('table');
                $('#employeeTable').addClass('table-hover');
            }
        });
    }
</script>
