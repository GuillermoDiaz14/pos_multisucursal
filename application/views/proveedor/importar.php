<div class="content-wrapper">
    ...
    <?php
                        ...
                        $imagen_url = base_url('uploads/' ."csv_proveedor_ventas.programacionparacompartir.csv");
                        ?>  
            ...
            <div class="col-md-8">
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    ...
                    <form method="post" enctype="multipart/form-data" action="<?php echo base_url('proveedor/importar_proveedor'); ?>">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-7">                                
