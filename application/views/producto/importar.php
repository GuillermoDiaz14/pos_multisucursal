<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-user-circle-o" aria-hidden="true"></i> Importar producto
        <small>Importar</small>
      </h1>
    </section>
    <?php

                        $imagen_url = base_url('uploads/' ."plantilla.csv");
                        ?>  
              ...
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title"> Importar producto</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    <?php $this->load->helper("form"); ?>
                    <form method="post" enctype="multipart/form-data" action="<?php echo base_url('producto/importar_producto'); ?>">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-7">                                
