<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-users"></i> Administrar Roles 
                  ...
                  <table class="table table-hover" id="miTabla">
                    ...
                    <td><?php echo $record->nombre_sucursal ?></td>
                        ...
                        <td class="text-center">
                            ...
                            <a class="btn btn-sm btn-danger deleteUser" href="#" data-userid="<?php echo $record->userId; ?>" title="Eliminar"><i class="fa fa-trash"></i></a>
                        </td>
                    </tr>
                    <?php
                        }
