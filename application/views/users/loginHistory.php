...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-users"></i> historial Login
        <small>Historial login</small>
      </h1>
    </section>
        ...
        <div class="row">
          <form action="<?php echo base_url() ?>login-history" method="POST" id="searchList">
            ...
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 form-group">
              <input id="searchText" type="text" name="searchText" value="<?php echo $searchText; ?>" class="form-control" placeholder="Buscar texto"/>
            </div>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                    <h3 class="box-title"><?= !empty($userInfo) ? $userInfo->name." : ".$userInfo->email : "Todos los usuarios" ?></h3>
                    <div class="box-tools">
                    </div>
                </div><!-- /.box-header -->
                <div class="box-body table-responsive no-padding">
                  <table class="table table-hover">
                    <tr>
                      <th>Datos de sesiion</th>
                      <th>Direccion IP</th>
                      <th>Agente de usuario</th>
                      <th>Cadena completa del agente</th>
                      <th>Plataforma</th>
                      <th>Fecha y hora</th>
                    </tr>
                    <?php
                    ...
                    <tr>
                      ...
                      <td><?php echo fmt_fecha($record->createdDtm, false, '-') ?></td>
                    </tr>
                    <?php
                        }
                    }
