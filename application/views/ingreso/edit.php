...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-user-circle-o" aria-hidden="true"></i> Ingreso
        <small>Ingreso / Editar Ingreso</small>
      </h1>
    </section>
            ...
            <div class="col-md-8">
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" action="<?php echo base_url() ?>ingreso/editIngreso" method="post" id="editIngreso" role="form">
                        <div class="box-body">
                        <div class="row">
                                <div class="col-md-6">        
                                ...
                                <div class="form-group">
                                        ...
                                        <input type="hidden" value="<?php echo $id_ingreso; ?>" name="id_ingreso" id="id_ingreso" />
                                    </div>
