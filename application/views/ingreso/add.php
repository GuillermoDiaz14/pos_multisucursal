...
<div style="padding:16px 20px;">
    ...
    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:16px;flex-wrap:wrap;gap:8px;">
        <div>
            <h3 style="margin:0;font-size:18px;color:#2c3e50;font-weight:700;">
                <i class="fa fa-arrow-circle-down text-success"></i> Registrar ingreso
            </h3>
            <p style="margin:2px 0 0;font-size:12px;color:#aaa;">Registra un nuevo ingreso de la sucursal</p>
        </div>
    ...
    <div class="form-card">
        ...
        <form role="form" id="addIngreso" action="<?php echo base_url(); ?>ingreso/addNewIngreso" method="post">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="descripcion" id="descripcion"
                                  rows="3" maxlength="200" placeholder="Ej: Cobro de servicio, abono de cliente, venta especial…"
        ...
        <div class="form-card-footer">
            <button type="submit" class="btn btn-success"><i class="fa fa-save"></i> Registrar ingreso</button>
