<div class="content-wrapper">
    ...
    <section class="content report-shell" data-report-root data-report-title="Caja operativa" data-report-subtitle="Control operativo de efectivo">
        <?php
        $reportExportTitle = 'Caja operativa';
        $reportExportSubtitle = 'Control operativo de efectivo';
