...
.monto-preview{font-size:22px;font-weight:700;color:#e74c3c;margin-top:6px;min-height:28px}
</style>
...
<div style="padding:16px 20px;">
    ...
    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:16px;flex-wrap:wrap;gap:8px;">
        <div>
            <h3 style="margin:0;font-size:18px;color:#2c3e50;font-weight:700;">
                <i class="fa fa-money text-danger"></i> Registrar gasto
            </h3>
            <p style="margin:2px 0 0;font-size:12px;color:#aaa;">Registra un nuevo gasto de la sucursal</p>
        </div>
        <a class="btn btn-default btn-sm" href="<?php echo base_url(); ?>gasto/gasto_lista">
    ...
    <div class="form-card">
        <div class="form-card-header">
            <i class="fa fa-money text-danger" style="font-size:18px;"></i>
            <h4>Datos del gasto</h4>
        </div>

        <form role="form" id="addGasto" action="<?php echo base_url(); ?>gasto/addNewGasto" method="post">
        <div class="form-card-body">

            <p class="form-section-title">Información del gasto</p>
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        <label>Descripción <span style="color:#e74c3c;">*</span></label>
                        <textarea class="form-control" name="descripcion" id="descripcion"
                                  rows="3" maxlength="200" placeholder="Ej: Pago de servicios, compra de insumos…"
                                  autofocus required><?php echo htmlspecialchars(set_value('descripcion'), ENT_QUOTES); ?></textarea>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="monto" id="monto"
                               value="<?php echo htmlspecialchars(set_value('monto'), ENT_QUOTES); ?>"
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" name="fecha" id="fecha"
                               value="<?php echo htmlspecialchars(set_value('fecha', date('Y-m-d')), ENT_QUOTES); ?>"
                               required />
                    </div>
                </div>
            </div>
        ...
        <div class="form-card-footer">
            <button type="submit" class="btn btn-danger"><i class="fa fa-save"></i> Registrar gasto</button>
            <a href="<?php echo base_url(); ?>gasto/gasto_lista" class="btn btn-default">Cancelar</a>
        </div>
        </form>
    </div>
...
// Inicializar con valor existente (rerenderizado tras error de validación)
