        ...
        <div class="row">
            <div class="col-xs-12 text-right">
                <div class="form-group">
                    <a class="btn btn-primary" href="<?php echo base_url(); ?>entrada/entrada"><i class="fa fa-plus"></i> Agregar nueva compra</a>
                </div>
            </div>
        </div>
        <div class="row">
                ...
                <div class="box-header">
                    ...
                    <div class="box-tools">
                            ...
                            <div class="input-group">
                              <input type="text" name="searchText"   class="form-control input-sm pull-right" style="width: 150px;" placeholder="por proveedor/Nro compra" id="searchText" oninput="filterTable()" />
...
<script>
    function filterTable() {
        ...
        $.ajax({
            url: '<?php echo base_url() ?>entrada/filterEntradas',
            type: 'POST',
