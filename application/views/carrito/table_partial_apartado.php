<?php if (!empty($records)): ?>
    <?php foreach ($records as $record):
        ...
        if ($estado === 'entregado')  { $badgeClass = 'badge-entregado'; $estadoLabel = 'Entregado'; }
        if ($estado === 'cancelado')  { $badgeClass = 'badge-cancelado'; $estadoLabel = 'Cancelado'; }
    ?>
    <tr>
        ...
        <td><?php echo '$' . number_format((float)(isset($record->anticipo) ? $record->anticipo : 0), 2); ?></td>
    ...
    <?php endforeach; ?>
<?php else: ?>
    <tr><td colspan="9" class="text-center text-muted">No se encontraron apartados</td></tr>
<?php endif; ?>
