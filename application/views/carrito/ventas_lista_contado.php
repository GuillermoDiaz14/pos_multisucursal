...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-user-circle-o" aria-hidden="true"></i> Ventas al contado
...
<?php
 ...
 <a class="btn btn-sm btn-info" href="<?php echo base_url().'carrito/exportToPDF/'.$record->id_venta; ?>" title="ticket" target="_blank"><i class="fa fa-file-text-o"></i></a>
