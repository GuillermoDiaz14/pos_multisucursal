...
.hv-card-icon.green{background:#27ae60}.hv-card-icon.blue{background:#2980b9}.hv-card-icon.red{background:#e74c3c}.hv-card-icon.gray{background:#7f8c8d}
...
.hv-pag-btns button.active{background:#27ae60;color:#fff;border-color:#27ae60;font-weight:600}
.hv-pag-btns button:disabled{opacity:.4;cursor:default}
@media(max-width:900px){.hv-cards{grid-template-columns:repeat(2,1fr)}}
@media(max-width:576px){.hv-wrapper{padding:10px}.hv-cards{grid-template-columns:1fr 1fr;gap:8px}.hv-card{padding:10px 12px}.hv-card-value{font-size:17px}.hv-card-icon{width:38px;height:38px;font-size:17px}.hv-search-wrap input{width:160px}.col-vendedor,.col-impuesto,.col-base{display:none}}
</style>
...
<div class="hv-wrapper">
    ...
    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:16px;flex-wrap:wrap;gap:8px;">
        <div>
            <h3 style="margin:0;font-size:18px;color:#2c3e50;font-weight:700;">
                <i class="fa fa-money text-success"></i> Ventas al contado
            </h3>
            <p style="margin:2px 0 0;font-size:12px;color:#aaa;">Ventas cobradas de inmediato</p>
        </div>
    ...
    <div class="hv-cards">
        <div class="hv-card">
            ...
            <div class="hv-card-body">
                ...
                <div class="hv-card-label">Total cobrado</div>
            </div>
        </div>
        <div class="hv-card">
            ...
            <div class="hv-card-body">
                ...
                <div class="hv-card-label">Ventas contado</div>
            </div>
        </div>
        <div class="hv-card">
        ...
        <div class="hv-card">
            <div class="hv-card-icon blue"><i class="fa fa-bar-chart"></i></div>
            <div class="hv-card-body">
    ...
    <div class="hv-box">
        ...
        <div class="table-responsive">
            <table class="hv-table" id="tablaVentasContado">
                <thead>
                    <tr>
                ...
                <tbody id="tablaVentasContadoTbody">
        ...
        <div class="hv-pagination">
            <div class="hv-pag-info" id="pag-info-contado">—</div>
            <div class="hv-pag-btns" id="paginacionContado"></div>
        </div>
    </div>
