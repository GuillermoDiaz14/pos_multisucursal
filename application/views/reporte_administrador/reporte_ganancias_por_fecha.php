...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-user-circle-o" aria-hidden="true"></i> Ganancias por producto
        <small>Reporte por sucursal</small>
      </h1>
    </section>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Ganancias registradas</h3>
    ...
    if (!empty($ventas['result'])) {
        foreach ($ventas['result'] as $venta) {
            ...
            <tr>
                ...
                <td><?php echo fmt_fecha($venta->fecha_venta, false, '-') ?></td>
            </tr>
            <?php
        }
    }
...
<script>
    ...
    $.ajax({
        url: '<?php echo base_url() ?>reporte_administrador/filterGanancia_entre_dos_fechas',
        type: 'POST',
