...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-user-circle-o" aria-hidden="true"></i> Compras por fecha
...
<script>
    function filterTable() {
     ...
     let id_sucursal = document.getElementById('id_sucursal').value;
        ...
        $.ajax({
            url: '<?php echo base_url() ?>reporte_administrador/filterCompra_fechas',
            type: 'POST',
    ...
    // Realizar la solicitud AJAX para obtener los resultados filtrados
    $.ajax({
        url: '<?php echo base_url() ?>reporte_administrador/filterCompra_entre_dos_fechas',
        type: 'POST',
