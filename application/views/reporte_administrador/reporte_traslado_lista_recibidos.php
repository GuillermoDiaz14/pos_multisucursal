<div class="content-wrapper">
    <section class="content-header">
        <h1><i class="fa fa-exchange"></i> Traslados recibidos <small>Reporte</small></h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo base_url('reporte_administrador/seleccion_traslado_recibido'); ?>"><i class="fa fa-arrow-left"></i> Cambiar sucursal</a></li>
        </ol>
    </section>

    <section class="content report-shell"
             data-report-root
             data-report-title="Traslados recibidos — <?php echo htmlspecialchars($nombre_sucursal); ?>"
             data-report-subtitle="Movimientos de inventario recibidos en esta sucursal">

        <?php
        $reportExportTitle       = 'Traslados recibidos — ' . $nombre_sucursal;
        $reportExportSubtitle    = 'Movimientos de inventario recibidos en esta sucursal';
        ...
        <div style="background:#f4f7fb;border:1px solid #d8e1eb;border-radius:12px;padding:12px 18px;margin-bottom:18px;display:flex;align-items:center;gap:12px">
            ...
            <span style="margin-left:auto;font-size:12px;color:#6b7280">
                <i class="fa fa-arrow-left"></i> Traslados <strong>recibidos</strong> desde otras sucursales
            </span>
        </div>
            ...
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <div class="box-header with-border" style="display:flex;align-items:center;justify-content:space-between;">
                        <h3 class="box-title" style="margin:0"><i class="fa fa-list"></i> Lista de traslados recibidos</h3>
                        ...
                        <table class="table table-hover table-condensed" id="miTabla">
                            ...
                            <tr>
                                <td colspan="6" class="text-center text-muted" style="padding:40px 20px">
                                    ...
                                    No se encontraron traslados recibidos para esta sucursal.
                                </td>
                            </tr>
                            <?php endif; ?>
                            </tbody>
...
(function () {
    ...
    window.filterTable = function () {
        $.ajax({
            url: '<?php echo base_url('reporte_administrador/filterTrasladarRecibidos'); ?>',
            type: 'POST',
            data: {
