...
<div class="content-wrapper">
    ...
    <section class="content report-shell" data-report-root data-report-title="Traslados recibidos" data-report-subtitle="Seguimiento de movimientos recibidos entre sucursales">
        <?php
        $reportExportTitle = 'Traslados recibidos';
        $reportExportSubtitle = 'Seguimiento de movimientos recibidos entre sucursales';
                    ...
                    <div class="box-tools">
                        <form action="<?php echo base_url() ?>reporte_administrador/trasladar_lista" method="POST" id="searchList">
                            ...
                            <input type="hidden" value="<?php echo $id_sucursal; ?>" name="id_sucursal" id="id_sucursal" />
                              <input type="text" name="searchText"   class="form-control input-sm pull-right" style="width: 150px;" placeholder="sucursal/Nro traslado" id="searchText" oninput="filterTable()" />
