            ...
            <div class="col-md-8">
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" id="reporte_venta_producto_mas_vendido" action="<?php echo base_url() ?>reporte_administrador/reporte_venta_productos_mas_vendidos" method="post" role="form">
                        <div class="box-body">
                            <div class="row">
